...
defaults(end+1,:) = {'blastDatabase','string','/mnt/data/sedona/Data/GenomeData/GenomeAssemblies/mm10/mm10.fasta'};
...
[~,blastData] = BLAST(libName,pars.blastDatabase,'numThreads',36,'wordSize',pars.blastWordSize,'verbose',pars.verbose);
...
[~,~] = system(['cat ', headerfile, ' ', datafile, ' > ', bedfile]);
