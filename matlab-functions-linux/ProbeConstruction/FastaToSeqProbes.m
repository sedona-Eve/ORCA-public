...
currReadouts = '/mnt/data/sedona/Data/Oligos/CommonOligos/v6_Adapters1_readouts001-384_240212.fasta'; % introduced 04/0/23

defaults = cell(0,3);
defaults(end+1,:) = {'verbose', 'boolean', true}; 
defaults(end+1,:) = {'veryVerbose', 'boolean', false}; 
defaults(end+1,:) = {'fwdPrimers', 'fasta', fastaread('/mnt/data/sedona/Data/Oligos/CommonOligos/FwdPrimers.fasta')}; % FwdPrimers
defaults(end+1,:) = {'revPrimers', 'fasta', fastaread('/mnt/data/sedona/Data/Oligos/CommonOligos/RevPrimers.fasta')}; % RevPrimers
