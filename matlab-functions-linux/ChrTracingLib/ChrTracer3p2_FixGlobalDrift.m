...
fileStruct = dir(fullfile(pars.saveFolder, '*_regData.csv')); % Use fullfile for path compatibility
foundFiles = {fileStruct.name}';                             % Extract file names into a cell array
