function [xy0,ptMap1] = TraceCenters(xs1,ys1,varargin)
...
if pars.showPlots > 0 
    figure(pars.showPlots); clf; imagesc(ptMap1); colorbar;  clim([pars.minSpotsPerBin,10*pars.minSpotsPerBin])
    hold on; plot(spots1(:,1),spots1(:,2),'ro');
end
